...
from agent import (
    fetch_html, extract_metadata, convert_to_markdown,
    download_images, insert_metadata, generate_pdf
)
...
class TestGeneratePDF:
    ...
    def test_generate_pdf_success(self, mock_run):
        ...
        with patch('builtins.open', mock_open(read_data='\\includegraphics{test}')) as mock_file:
            try:
